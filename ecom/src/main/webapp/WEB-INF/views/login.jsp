      ...
      <div class="account-login">
        ...
        <fieldset class="col2-set">
          ...
          <div class="col-1 new-users"><strong>New Customers</strong>
            <div class="content">
              <p>By creating an account with our store, you will be able to utilize all of our features</p>
              <div class="buttons-set">
                <a href="signup"><button class="button create-account"><span>Create an Account</span></button></a>
              </div>
            </div>
          </div>
